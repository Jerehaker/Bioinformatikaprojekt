...
//this function is used here because for some reason every second sequence they test is reverse complemented :))

std::string ReverseComplement (std::string const &sequence) {
